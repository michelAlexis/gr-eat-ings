import QuantityInput from '@/components/ingredients/Quantity.input';
import { IngredientDetail, Quantity } from '@/models/ingredient.model';
import { reduceNutrition } from '@/utils/ingredient.utils';
...
export const IngredientCalculatorTable: FC<{
  ...
  const columns: ColumnDef<{ ingredient: IngredientDetail; quantity: Quantity }>[] = [
    {
      id: 'ingredient',
